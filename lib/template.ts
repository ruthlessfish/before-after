...
:host([orientation="vertical"]) .pane.before {
...
:host([orientation="vertical"]) .label.after {
  top: auto;
  bottom: 0;
  right: 0;
}
...
:host([orientation="vertical"]) .handle svg {
...
.handle.by-pointer:focus-visible {
  outline: none;
}
...
.frame:not(.is-dragging) .pane.before {
  transition: clip-path .18s ease;
}
.frame:not(.is-dragging) .rail {
  transition: left .18s ease, top .18s ease;
}

/* Selectors must match the rules above exactly: :not(.is-dragging) adds a
   class to their specificity, and a shorter override here would lose. */
